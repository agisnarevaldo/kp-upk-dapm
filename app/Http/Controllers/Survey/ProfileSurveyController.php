...
class ProfileSurveyController extends Controller
{
    public function index()
    {
       $user =  User::find(Auth::user()->id);
        ...
        return view('survey.profile.profile', compact(['user','detail']));
    }
    ...
    public function update_profile(Request $request, $id)
    {
        ...
        return to_route('survey.profile')->with('success','Berhasil Perbaharui Data Profile');
    }
    ...
    public function password()
    {
        ...
        return view('survey.profile.password', compact(['user']));
    }
