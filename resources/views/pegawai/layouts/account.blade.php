<div class="float-right">
    ...
    <div class="dropdown d-inline-block">
        ...
        <div class="dropdown-menu dropdown-menu-right">
            <!-- item-->
            <a class="dropdown-item" href="{{ route('pegawai.profile') }}"><i class="mdi mdi-face-profile font-size-16 align-middle mr-1"></i> Profile</a>
            <a class="dropdown-item" href="{{ route('pegawai.password') }}"><i class="mdi mdi-key-link font-size-16 align-middle mr-1"></i> Ubah Password</a>
